; ModuleID = '/tmp/pycharm_project/tmp/LLVM/cpp_files/sqrt_minus.cpp'
...
define double @_Z10sqrt_minusd(double %x) #2 {
  %1 = alloca double, align 8
  store double %x, double* %1, align 8
  %2 = load double* %1, align 8
  %3 = fadd double %2, 1.000000e+00
  %4 = call double @sqrt(double %3) #1
  %5 = load double* %1, align 8
  %6 = call double @sqrt(double %5) #1
  %7 = fsub double %4, %6
  ret double %7
}
...
; Function Attrs: nounwind uwtable
define zeroext i1 @_Z7is_zerod(double %x) #2 {
  %1 = alloca double, align 8
  store double %x, double* %1, align 8
  %2 = load double* %1, align 8
  %3 = call double @_Z10sqrt_minusd(double %2)
...
define i32 @main() #4 {
  ...
  store i32 0, i32* %1
  %2 = call double @_Z10sqrt_minusd(double 1.000000e+00)
  %3 = call %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* @_ZSt4cout, double %2)
